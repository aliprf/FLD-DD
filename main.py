...
if __name__ == '__main__':
    ...
    cofw.create_train_set(need_pose=False, need_hm=True, need_tf_ref=True,
    ...
    wflw.create_train_set(need_pose=False, need_hm=True, accuracy=pca_accuracy)  # todo DON'T FORGET to relabel after fli;
    ...
    w300w.create_train_set(need_pose=False, need_hm=True, accuracy=pca_accuracy)  # todo DON'T FORGET to relabel after fli;
